...
# 
# 
# tks_0626_0704 <- tokenize(corpus_0626_0704, what = "fasterword", remove_numbers = T,  remove_punct = T)
...
textplot_wordcloud(dfm_0626_0704, min.freq = 45000, random.order = FALSE,
...
control = list(seed = 2016, burnin = 5000, thin = 3, iter = 3000)

lda30_100_4_control2 <- list(Gibbs = LDA(dfm_trimed_100_4, 30, method = "Gibbs", control = control))
save(lda30_100_4_control2, file = "lda30_100_control2.RData")

lda30_200_4_control2 <- list(Gibbs = LDA(dfm_trimed_200_4, 30, method = "Gibbs", control = control))
save(lda30_200_4_control2, file = "lda30_200_4_control2.RData")

lda30_500_4_control2 <- list(Gibbs = LDA(dfm_trimed_500_4, 30, method = "Gibbs", control = control))
save(lda30_500_4_control2, file = "lda30_500_4_control2.RData")
...
lda50_100_4_control2 <- list(Gibbs = LDA(dfm_trimed_100_4, 50, method = "Gibbs", control = control))
save(lda50_100_4_control2, file = "lda50_100_4_control2.RData")

lda50_200_4_control2 <- list(Gibbs = LDA(dfm_trimed_200_4, 50, method = "Gibbs", control = control))
save(lda50_200_4_control2, file = "lda50_200_4_control2.RData")

lda50_500_4_control2 <- list(Gibbs = LDA(dfm_trimed_500_4, 50, method = "Gibbs", control = control))
save(lda50_500_4_control2, file = "lda50_500_4_control2.RData")


# run topic model, set number of topics 100
lda100_100_4_control2 <- list(Gibbs = LDA(dfm_trimed_100_4, 100, method = "Gibbs", control = control))
save(lda100_100_4_control2, file = "lda100_100_4_control2.RData")

lda100_200_4_control2 <- list(Gibbs = LDA(dfm_trimed_200_4, 100, method = "Gibbs", control = control))
save(lda100_200_4_control2, file = "lda100_200_4_control2.RData")

lda100_500_4_control2 <- list(Gibbs = LDA(dfm_trimed_500_4, 100, method = "Gibbs", control = control))
save(lda100_500_4_control2, file = "lda100_500_4_control2.RData")
